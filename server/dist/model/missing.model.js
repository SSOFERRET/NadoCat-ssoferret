...
exports.deleteMissingCat = exports.createMissingCat = exports.updateMissingReportCheckByPostId = exports.updateFoundByPostId = exports.updateMissingReportByPostId = exports.updateMissingByPostId = exports.addMissingReport = exports.getMissingReportsByMissingId = exports.getImageFormatsByPostId = exports.getLocationFormatsByPostId = exports.getMissingById = exports.getPostByPostId = exports.deleteLocationFormats = exports.deleteImageFormats = exports.addLocationFormats = exports.addImageFormats = exports.removePost = exports.getPostsCount = exports.getPostList = exports.addMissingCat = exports.addMissing = void 0;
...
const getPostList = (listData) => __awaiter(void 0, void 0, void 0, function* () {
    const { categoryId } = listData;
    switch (categoryId) {
        case 3: return yield getMissingsList(listData);
        case 4: return yield getMissingReportsList(listData);
    }
});
...
const getMissingReportsList = (listData) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, cursor, orderBy } = listData;
    const fetchMissingReportsByFoundStatus = (matchStatus, limit, cursor) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const matchList = yield fetchMissingReportsByFoundStatus("Y", limit, cursor);
    let remainingLimit = limit - matchList.length;
    const checkingList = remainingLimit > 0 ? yield fetchMissingReportsByFoundStatus("-", remainingLimit, cursor) : [];
    let posts = [...matchList, ...checkingList];
    remainingLimit = limit - posts.length;
    const unmatchList = yield fetchMissingReportsByFoundStatus("N", limit, cursor);
...
const updateMissingByPostId = (tx, postId, uuid, catId, detail, time) => __awaiter(void 0, void 0, void 0, function* () {
...
const createMissingCat = (tx, data) => __awaiter(void 0, void 0, void 0, function* () {
    yield tx.missingCats.create({
        data
    });
});
exports.createMissingCat = createMissingCat;
