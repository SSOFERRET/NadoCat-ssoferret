...
const getComments = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const count = yield (0, communityComment_model_1.getCommentCount)(postId);
        const comments = yield (0, communityComment_model_1.getCommunityComments)(postId, limit, cursor);
...
const createComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const newComment = yield (0, communityComment_model_1.addComment)(postId, userId, comment);
        if (newComment)
            yield (0, Notifications_1.notifyNewComment)(userId, category_1.CATEGORY.COMMUNITIES, postId, newComment.communityCommentId);
...
const updateComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, communityComment_model_1.updateCommentById)(postId, userId, commentId, comment);
...
const deleteComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const commentId = Number(req.params.comment_id);
        const userId = Buffer.from(uuid, "hex");
        yield (0, communityComment_model_1.deleteCommentById)(postId, userId, commentId);
