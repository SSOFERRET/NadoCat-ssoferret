...
const createEvent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, Searches_1.indexResultToOpensearch)(category_1.CATEGORY.EVENTS, newPost.postId);
    }
    catch (error) {
        console.error(error);
...
const updateEvent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield client_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield (0, Searches_1.updateOpensearchDocument)(category_1.CATEGORY.EVENTS, postId, { title, content });
        }));
...
const deleteEvent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield client_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield (0, Searches_1.deleteOpensearchDocument)(category_1.CATEGORY.EVENTS, postId);
        }));
