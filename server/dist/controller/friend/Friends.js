...
exports.unfollow = exports.follow = exports.followings = void 0;
...
const unfollow = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const followingId = Buffer.from(req.params.following_id, "hex");
        yield client_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            const friend = yield (0, friend_model_1.getFriendById)(tx, userId, followingId);
            if (!friend) {
                return res.status(http_status_codes_1.StatusCodes.NOT_FOUND).json({ meesage: "요청한 친구 정보를 찾을 수 없습니다." });
            }
            yield (0, friend_model_1.removeFriend)(tx, friend.friendId);
        }));
        res.status(http_status_codes_1.StatusCodes.OK).json({ message: "친구 삭제가 완료되었습니다." });
    }
    catch (error) {
        (0, errors_1.handleControllerError)(error, res);
    }
