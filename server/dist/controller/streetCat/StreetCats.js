...
exports.getStreetCatMap = exports.deleteStreetCat = exports.updateStreetCat = exports.createStreetCat = exports.getStreetCat = exports.getStreetCats = exports.getUuid = void 0;
    ...
    try {
        yield client_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            if (uuid) {
                ...
                const getPosts = yield (isNaN(cursor) ? (0, streetCat_model_1.readPosts)(tx, limit) : (0, streetCat_model_1.readPosts)(tx, limit, cursor));
...
const getStreetCat = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield client_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (getPost) {
                const viewIncrementResult = yield (0, Views_1.incrementViewCountAsAllowed)(req, tx, category_1.CATEGORY.STREET_CATS, postId);
...
//   }
// }
const getStreetCatMap = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const lat = parseFloat(req.query.lat);
        const lng = parseFloat(req.query.lng);
        const latRange = parseFloat(req.query.latRange);
        const lngRange = parseFloat(req.query.lngRange);
        if (isNaN(lat) || isNaN(lng) || isNaN(latRange) || isNaN(lngRange)) {
            return res.status(400).json({ message: "파라미터값 부족" });
        }
        const streetCatMap = yield (0, streetCat_model_1.readStreetCatMap)(lat, lng, latRange, lngRange);
        res.status(200).json(streetCatMap);
    }
    catch (error) {
...
exports.getStreetCatMap = getStreetCatMap;
