      ...
      <section className="street-cat-write-section">
        <form className="write-form-container" onSubmit={handleSubmit}>
          <div className="write-form name">
            ...
            <input className="name-input" type="text" name="name" placeholder="고양이 이름을 입력해주세요" 
          ...
          <button type="submit" className={`submit-btn ${isFormValid ? "active" : ""}`} disabled={!isFormValid}>작성완료</button>
        </form>
      </section>
    </>
  )
