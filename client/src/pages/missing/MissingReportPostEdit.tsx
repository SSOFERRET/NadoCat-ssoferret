...
import { useReadMissingReport, useUpdateMissingReportPost } from "../../hooks/useMissingReport";
...
const MissingReportPostEdit = () => {
  ...
  return (
    <>
      ...
      {data ? (
        <MissingReportPostEditForm initialData={data as IMissingReport} onSubmit={handleFormSubmit} />
      ) : (
        <LoadingCat />
      )}
    </>
